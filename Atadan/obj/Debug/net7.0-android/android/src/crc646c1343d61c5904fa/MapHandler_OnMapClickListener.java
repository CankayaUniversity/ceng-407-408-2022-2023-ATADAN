...
public class MapHandler_OnMapClickListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Maui.GoogleMaps.Handlers.MapHandler+OnMapClickListener, Maui.GoogleMaps", MapHandler_OnMapClickListener.class, __md_methods);
	}


	public MapHandler_OnMapClickListener ()
	{
		super ();
		if (getClass () == MapHandler_OnMapClickListener.class) {
			mono.android.TypeManager.Activate ("Maui.GoogleMaps.Handlers.MapHandler+OnMapClickListener, Maui.GoogleMaps", "", this, new java.lang.Object[] {  });
		}
	}
